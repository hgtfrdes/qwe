...
UUID=${UUID:-'31a6f48d-dd3a-4e02-8158-90604b2154a6'}
VMESS_WSPATH=${VMESS_WSPATH:-'/31a6f48d-dd3a-4e02-8158-90604b2154a6-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/31a6f48d-dd3a-4e02-8158-90604b2154a6-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/31a6f48d-dd3a-4e02-8158-90604b2154a6-trojan'}
SS_WSPATH=${SS_WSPATH:-'/31a6f48d-dd3a-4e02-8158-90604b2154a6-shadowsocks'}
